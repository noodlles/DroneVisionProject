...
if("TRUE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/me132/DroneVisionProject/DroneInterface/src/image_proc)
  set(image_proc_DEVEL_PREFIX /home/me132/DroneVisionProject/DroneInterface/devel)
  ...
  set(image_proc_INSTALL_PREFIX /home/me132/DroneVisionProject/DroneInterface/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'me132 <me132@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/me132/DroneVisionProject/DroneInterface/src/image_proc/${idir}'.  Ask the maintainer 'me132 <me132@todo.todo>' to fix it.")
    endif()
